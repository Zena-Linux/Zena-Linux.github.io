...
- **The `zix` binary**: This tool acts as an orchestrator. It modifies the `zix.json` manifest and runs the appropriate `nix` commands against the generated flake to manage your system state.